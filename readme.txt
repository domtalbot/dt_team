...
Installing "Bazzoo Team" can be done either by searching for "Bazzoo Team" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
